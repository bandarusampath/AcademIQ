			...
			<div class="col-md-6">
				<div class="form-group">
					...
					if ( $partial_payment_not_allowed ) {
						echo 'readonly'; }
					?>
					 type="number" step="any" min="0" name="payment_amount" class="form-control" id="wlsm_payment_amount" placeholder="<?php esc_attr_e( 'Enter amount', 'school-management' ); ?>" value="<?php echo esc_attr( WLSM_Config::sanitize_money( intval($payment_amount) + ( $due_date_amount ) ) ); ?>">
				</div>
				<div class="form-group">
